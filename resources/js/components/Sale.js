    ...
    constructor () {
      ...
      onSubmit(e){
          ...
          if(this.state.model != "" && this.state.service != "" && this.state.year != "" && this.state.stno != "" && this.state.vin != ""){
            ...
            axios.post('http://127.0.0.1:8000/api/sale/add',datas).then(res=>{
                ...
                <form onSubmit={ this.onSubmit }>
                    ...
                    <div className="col-md-3">
                        ...
                        <div className="col-md-3">
                            <div className="form-group">
                            <lable>VIN</lable>
                            <input value={ this.state.noplate } className="form-control"  placeholder="VIN" onChange={this.handleVinChange}/>
                            </div>
                        </div>
